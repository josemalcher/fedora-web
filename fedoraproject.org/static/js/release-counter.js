...
if (days < 0)
{
  document.write('<div class="fedora-banner"><a href="http://fedoraproject.org/wiki/Releases/8/Schedule"><img src="http://fedoraproject.org/images/banners/f8-banner-animation.gif" alt="Fedora 8 is here!" style="border: none;"></a></div>');
}
else
{
