_('&lt;a href="http://docs.fedoraproject.org/en-US/Fedora/13/html/Installation_Guide/sn-making-media.html"&gt;How do I use this file?&lt;/a&gt;')
_('&lt;a href="http://docs.fedoraproject.org/en-US/Fedora/13/html/Installation_Guide/ch-upgrade-x86.html"&gt;Fedora 13 Upgrade Guide&lt;/a&gt;')
_('Already have Fedora and want to upgrade to Fedora 13? Check out the &lt;a href="http://docs.fedoraproject.org/en-US/Fedora/13/html/Installation_Guide/ch-upgrade-x86.html"&gt;Upgrading Fedora&lt;/a&gt; instructions, and download the DVD ISO you\'ll need to start the upgrade process below.')
_('&lt;a href="http://docs.fedoraproject.org/en-US/Fedora/13/html/Installation_Guide/sn-making-media.html"&gt;How do I use this file?&lt;/a&gt;')
